...
CPPPATH_NODE = '/Users/chapel/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/chapel/local/node:/Users/chapel/local/node/lib/node_modules'
LIBPATH_NODE = '/Users/chapel/local/node/lib'
LIBPATH_SQLITE3 = ['/usr/local/lib', '/opt/local/lib']
LIBPATH_ST = '-L%s'
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
LINKFLAGS = []
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/chapel/local/node:/Users/chapel/local/node/lib/node_modules'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/chapel/local/node'
